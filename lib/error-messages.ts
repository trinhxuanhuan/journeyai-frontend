const ERROR_MESSAGE_MAP: Record<string, string> = {
  ...
  "Email hoac mat khau khong dung": "Email hoặc mật khẩu không chính xác.",
  "Ma OTP khong dung": "Mã xác thực không đúng. Vui lòng kiểm tra lại email.",
  ...
  "Tai khoan chua xac thuc OTP":
    "Tài khoản chưa được xác thực bằng mã trong email.",
